    ...
    return (
        <div className="hero">
            ...
            <div className="section">
                <h1>This is <br></br>the new way<br></br> to learn online</h1>
                <div className="sub-section">
                   <p> Lorem ipsum dolor sit, amet consectetur adipisicing elit. Reprehenderit debitis, itaque quos fugiat voluptas unde!</p>
